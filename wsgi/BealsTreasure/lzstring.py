...
class LZString:
    ...
    def __init__(self):
        self.keyStr = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/="  # nopep8
            ...
            if context_wc in context_dictionary:
                ...
                if context_w in context_dictionaryToCreate:
                    if ord(context_w[0]) < 256:
                        for i in range(context_numBits):  # @UnusedVariable
    ...
    def compressToBase64(self, string):
        ...
        while i < (strlen * 2):
            ...
            enc3 = ((chr2 & 15 if not math.isnan(chr2) else 0) << 2) | (
            ...
            output += self.keyStr[enc1] + self.keyStr[enc2] + \
    ...
    def decompress(self, compressed):
        ...
        dictSize = 4
        numBits = 3
        (entry, result, w, c) = ('', '', '', '')  # @UnusedVariable
        (i, nnext, bits, resb, maxpower, power) = (0, 0, 0, 0, 0, 0)  # nopep8 @UnusedVariable
